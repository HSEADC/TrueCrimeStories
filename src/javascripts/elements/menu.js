...
document.addEventListener('DOMContentLoaded', () => {
    function createMenu() {
        ...
        <nav class="menu-panel" aria-label="Navigation menu">
            <a href="/src/index.html" class="btn menu-panel__button">ГЛАВНАЯ</a>
            <a href="/src/pages/about.html" class="btn menu-panel__button">О НАС</a>
            <a href="/src/pages/files.html" class="btn menu-panel__button">ДОСЬЕ</a>
            <a href="/src/pages/articles.html" class="btn menu-panel__button">СТАТЬИ</a>
            <a href="/src/pages/podcasts.html" class="btn menu-panel__button">ПОДКАСТЫ</a>
            <a href="/src/pages/test-types.html" class="btn menu-panel__button">ТЕСТЫ</a>
        </nav>
